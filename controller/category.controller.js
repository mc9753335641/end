import '../model/cateory.model.js'
import  CategorySchemaModel from '../model/cateory.model.js'
import url from 'url';
...
export var save=async (req,res,next)=>{
    ...
    var uploadpath=path.join(__dirname,"../../ship/public/asstes/uplode/caticon",caticonnm);
