...
import subcatageorySchemaModel from '../model/shipmentmodel.js';
...
var siconnm=sicon.name
 userdetail.shipmenticonnm=siconnm;
 var uplodepath=path.join(__dirname,"../../ship/public/asstes/uplode/shipicon",siconnm)
 var userlist=await  subcatageorySchemaModel.find()
 var l=userlist.length;
 var _id=l==0?1:userlist[l-1]._id+1;
 userdetail={...userdetail,"_id":_id,"info":Date.now()}
try
{
